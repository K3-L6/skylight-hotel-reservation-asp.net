<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rooms_Standard _Reservation.aspx.cs" Inherits="Home" %>
...
<body>
        ...
        <h1 style="font-family:'Century Gothic'; font-size:45px; text-align:center; padding-top:2%; padding-bottom:2%;">STANDARD RESERVATION FORM</h1>
        <form runat="server">
