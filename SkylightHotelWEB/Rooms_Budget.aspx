<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Rooms_Budget.aspx.cs" Inherits="Home" %>
...
<body>
        ...
        <h1 style="font-family:'Century Gothic'; font-size:45px; text-align:center; padding-top:2%; padding-bottom:2%;">BUDGET ROOM FACILITIES</h1>
        ...
        <div class="col-md-2 col-md-offset-5">
            <button type="button" class="btn btn-primary btn-block" onclick="location.href='Rooms_Budget_Reservation.aspx'">Reserve Now</button>
        </div>
